    ...
    return (
        <React.Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <Nav.Item as="li">
                    <Link className={`${location.pathname === '/dashboards/app/dance-newsfeed' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboards/app/dance-newsfeed">
                ...
                <Nav.Item as="li">
                    <Link className={`${location.pathname === '/dashboards/app/dance-events' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboards/app/dance-events">
