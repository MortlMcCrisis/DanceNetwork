...
public class KeycloakJwtTokenConverter implements Converter<Jwt, JwtAuthenticationToken> {
  ...
  @Value("${token.converter.principal-attribute}")
  private String principalAttribute;

  @Value("${token.converter.resource-id}")
  ...
  private String getPrincipalClaimName(Jwt jwt){
    return jwt.getClaim(principalAttribute == null ? JwtClaimNames.SUB : principalAttribute);
  }
}
